...
class BrowserSettings extends Observable {
    ...
    static class Observer implements java.util.Observer {
	   ...
	   /* if (b.lockLandscape())
	    ...
	    Log.d("browser","PN: mobile web - "+b.mobileVersion);
	...
	//mobileVersion = p.getBoolean("mobile_webpn",mobileVersion);
	
	Log.d("browser","PN: syncprefs - mobile web - "+mobileVersion);
	Log.d("browser","PN: syncprefs - onscreen zoom -"+onscreenZoom);
