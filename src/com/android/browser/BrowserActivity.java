...
public class BrowserActivity extends Activity
 ...
 /*       // Keep a settings instance handy.
	...
	{
		this.setRequestedOrientation(-1); // orient by user setting in OS
	}
...
/*    public boolean onSingleTapConfirmed(MotionEvent e)
    {
	Log.d(LOGTAG,"PN: double tap - onSingleTapConfirmed");
	return true;
    }

    public boolean onDoubleTapEvent(MotionEvent e)
    {
	Log.d(LOGTAG,"PN: double tap - onDoubleTapEvent");
	return true;
    }

    public boolean onDoubleTap(MotionEvent e)
    {
	Log.d(LOGTAG,"PN: double tap - onDoubleTap");
	return true;
    } */
...
//----------------- MultiTouch stuff ------------------
	...
	Log.d("PN","mCurrZoom = "+mCurrZoom+" getZoomWidth = "+webView.getScale());
        return true;
    }
